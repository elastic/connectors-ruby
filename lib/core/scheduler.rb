...
module Core
  class Scheduler
    ...
    def when_triggered
      ...
      rescue Utility::AuthorizationError => e
        Utility::Logger.error('Could not retrieve connectors settings due to authorization error. Check debug logs for full error message.')

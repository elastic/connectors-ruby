...
RSpec.describe Utility::Cron do
  it 'supports various expressions' do
    conversions = [
      ...
      ['0 20 6 ? * 5', '20 6 * * 5'], # every Friday at 6:20 AM
      ['0 0 12 ? * 2', '0 12 * * 2'], # every Tuesday at 12:00 PM
      ['0 0 0 ? * 7', '0 0 * * 7'], # every Sunday at 12:00 AM
    ...
    conversions.each do |quartz, crontab|
      ...
      print "### next_time for #{crontab}: #{next_time}\n"
